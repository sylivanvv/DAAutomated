...
public class CvPage {
    ...
    @FindBy(className = "cv-submit-margin")
    private WebElement submitButton;


    public CvPage fillApplyForm(String firstname, String lastname, String skype, String bday, String bmonth,
        ...
        Select selectEduEndYear = new Select (eduLevel);
